...
<head>
    ...
    <title>Keliling Banyuwangi 1 | Paket Tour Wisata Malang Bromo Murah Terbaik</title>
  <!-- whatsapp -->
...
<body>
    ...
    <div id="carouselExampleIndicators" class=" carousel slide" data-ride="carousel" style="height:600px;">
      ...
      <!-- Main text table -->
      <main>
        <div class="row textmain"style="padding-top: 40px;">
              ...
              <div class="profile-text-main pl-lg-2">
                ...
                <div class="tab-content" id="nav-tabContent">
                  <div class="tab-pane fade show active" id="nav-detailtrip" role="tabpanel" aria-labelledby="nav-detailtrip-tab">
                   ...
                   <strong> Meeting Point </strong> <span style="font-weight: lighter;">: KotaBanyuwangi</span> 
                   <br><br>
                   <strong>Spot Wisata Keliling Banyuwangi :</strong><br><br>
                   ...
                   <p style="font-weight: lighter;">
                    ...
                    - Wisata Kuliner Bakso President khas Malang<br><br>
                  </p>
