    ...
    <div class="row main">
      <div class="col-lg-8 pl-lg-5">
        <div class="card card-profile">
          <img src="{{ url('frontend/images/profil-kami/Banner-Jendelajnk-1.gif') }}" width="100%" height="100%" alt="">
      ...
      <div class="col-lg-4">
        <div class="card-profile">
          <a class="katalog" href="{{route('BromoBatu')}}">
            <img src="{{ url('frontend/images/katalog/Bromo-Batu.jpg') }}" width="280" height="280" alt="">
          </a>
        </div>
        <div class="card-profile pt-5">
          <a class="katalog" href="{{ route('TourKawahIjen') }}">
            <img src="{{ url('frontend/images/katalog/Ijen-Midnight.jpg') }}" width="280" height="280" alt="">
          </a>
        </div>
      </div>
    </div>
