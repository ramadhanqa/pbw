        ...
        <div class="col-lg-4">
          <div class="card-profile">
            <a class="katalog" href="{{ route('BromoBatu') }}">
              <img src="{{ ulr('../../frontend/images/katalog/detail5.jpg') }}" width="280" height="280" alt="">
            </a>
          </div>
...
<div class="row three">
    <div class="col-lg-7 pl-lg-5">
      <div class="card card-instgram">
        ...
        <img class="rounded-circle" width="65px" height="65px" src="{{ url('../../frontend/images/logoig.JPG') }}" alt=""><p style="font-weight: lighter; padding-left: 90px; width: 1000px; margin-top: -50px; padding-bottom: 30px;">jendelawisata</p>
