...
@section('title')
Open Trip Bromo | Paket Tour Wisata Malang Bromo Murah Terbaik
@endsection
@section('content')
<!-- Jumbotron -->
    ...
    <ol class="carousel-indicators" style="height: 800px;">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <img class="d-block w-100" src="{{ url('../../frontend/images/katalog/1D_Tour/jumbotron4.JPG') }}" alt="Second slide">
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src="{{ url('../../frontend/images/katalog/1D_Tour/jumbotron2.JPG') }}" alt="Third slide">
        </div>
            ...
            <div class="profile-text-main pl-lg-2">
              ...
              <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-detailtrip" role="tabpanel" aria-labelledby="nav-detailtrip-tab"><br>
                 <strong> Jadwal </strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span  style="font-weight: lighter;">:  Setiap Hari Sabtu & Minggu</span>  <br>
                 <strong>Sifat Trip </strong>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="font-weight: lighter;">: Opentrip (digabung dengan peserta lainnya)</span>  <br>
                 <strong> Meeting Point </strong> <span style="font-weight: lighter;">: Kota Malang dan Batu (lokasi bebas)</span>
                 <br><br>
                 <p style="font-weight: lighter;">
                   <strong style="font-weight: bold;">Destinasi Wisata Tour Bromo</strong> <br>
                    - Penanjakan 1 Sunrise <br>
                    - Bukit Kingkong (optional) <br>
                    - Bukit Cinta (optional) <br>
                ...
                <div class="tab-pane fade" id="nav-hargatour" role="tabpanel" aria-labelledby="nav-hargatour-tab"><br>
                 <strong>1 orang    : 450.000,- / orang</strong><br>
                  <p style="font-weight: lighter;">2 orang      : 350.000,- /orang<br>
                    3 orang      : 350.000,- /orang<br>
                    4 orang      : 350.000,- /orang<br>
                    5 orang       : 350.000,- /orang<br><br>
                    <p style="font-style: italic;">*Dan hingga kelipatan seterusnya tetap dikenakan biaya per-orang sebesar 350.000,- / Orang</p>
                  </p>
                </div>
                <div class="tab-pane fade" id="nav-fasilitas" role="tabpanel" aria-labelledby="nav-fasilitas-tab"><br>
                  <p style="font-weight: lighter;">
                    ...
                    √ Transport dari Meeting Point – Bromo PP (Avanza / Luxio)<br>
                    √ Jeep 4x4 selama Explore di Bromo<br>
                    √ Driver, BBM & Parkir Tol<br>
                    √ Tiket entrance kawasan Bromo<br>
                    <strong style="font-weight: bold;">√ Makan Prasmanan setelah dari Bromo</strong> <br>
                    √ Air Mineral & Masker<br>
                    √ Driver Jeep as Guide<br>
                    √ P3K Ringan<br>
                    √ Asuransi Taman Nasional<br>
                    <strong style="font-weight: bold;">√ Asuransi All Risk</strong>
                     <br><br>
                ...
                <div class="tab-pane fade" id="jadwalperjalanan" role="tabpanel" aria-labelledby="jadwalperjalanan"><br>
                  <p style="font-weight: lighter;">
                    23.30 : Start penjemputan peserta sesuai kesepakatan<br>
                    24.00 : Menuju Bromo (Sudah masuk di hari berikutnya)<br>
                    02.30 : Sampai di Park Area Wonokitri Parking Area (oper jeep 4×4) / di Villa Transit<br>
                    ...
                    10.30 : Kembali di Park Area Wonokitri<br>
                    11.30 : Bersih diri, Makan pagi (disekitaran parking area / di villa transit) dan kembali ke Meeting Point<br>
                    13.30 : diperkirakan tiba di Meeting Point<br> <br>
