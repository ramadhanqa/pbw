...
<head>
    ...
    <title>Keliling Banyuwangi 2 | Paket Tour Wisata Malang Bromo Murah Terbaik</title>
  <!-- whatsapp -->
          ...
          <div class="col-lg-4">
            ...
            <div class="card-profile pt-5">
              <a class="katalog" href="../../halaman/Tour3D2N/TourBromo&MalangBatu.html ">
                <img src="../../frontend/images/katalog/detail1.jpg" width="298.55" height="298.55" alt="">
              </a>
            </div>
            <div class="card-profile pt-5">
