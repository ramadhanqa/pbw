...
Tour Bromo & Malang Batu | Paket Tour Wisata Malang Bromo Murah Terbaik
...
<div id="carouselExampleIndicators" class=" carousel slide" data-ride="carousel" style="height: 450px;">
    ...
    <!-- Main text table -->
    <main>
      <div class="row textmain" style="padding-top: 100px;">
        <div class="col-lg-8 pl-lg-5">
          <div class="card card-profile-main">

            <div class="profile-text-main pl-lg-2">
              <p class="font-weight-bold">Paket Tour Bromo & Malang Batu</p>
              ...
              <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-detailtrip" role="tabpanel" aria-labelledby="nav-detailtrip-tab"><br>
                 ...
                 <strong> Meeting Point </strong> <span style="font-weight: lighter;">: Kota Malang & Surabaya</span>
                 <br><br>
                 <p style="font-weight: lighter;">
                   <strong  style="font-weight: bold;">Destinasi Favorit  Tour Bromo Malang Batu</strong> <br><br>
                   <strong style="font-weight: bold;">Hari ke 1</strong><br>
                    - Wisata Petik Apel <br>
                    - Wisata Taman Bunga Selecta <br>
                    - Jatim Park 2 (Museum Satwa & Batu Secret Zoo) / Jatim Park 3 (The Legend Star dan Dino Park ) <br><br>
                    ...
                    - Kuliner Ketan Legenda khas Kota Batu <br><br>
                    ...
                    - Wisata Kuliner Bakso President khas Malang
                 </p>
                </div>
                <div class="tab-pane fade" id="nav-hargatour" role="tabpanel" aria-labelledby="nav-hargatour-tab"><br>
                  ...
                  <I><strong>Pilihan Hotel *2 :Seulawah Grand View Hotel Batu, Fave Hotel, Front One Boutique Batu. Maxone Hotel</strong> <br>
                    <strong>Pilihan Hotel *3 :Samara Resort Batu, Aston in hotel Batu, Swiss Bell Hotel, 101 Oj Hotel</strong> <br><br>

                    <strong>*Peserta diatas 6 Orang Silahkan menghubungi kontak kami<br><br>
                ...
                <div class="tab-pane fade" id="nav-fasilitas" role="tabpanel" aria-labelledby="nav-fasilitas-tab"><br>
                  <p style="font-weight: lighter;">
                    ...
                    √ Transportasi Selama Tour (1-5 Orang <strong style="font-weight: bold;">Innova</strong>, 6 Orang<strong style="font-weight: bold;"> Elf Short</strong>, 7-12 <strong>Toyota Hiace</strong> dan seterusnya) <br>
                ...
                <div class="tab-pane fade" id="jadwalperjalanan" role="tabpanel" aria-labelledby="jadwalperjalanan"><br>
                  <p style="font-weight: lighter;">
                    ...
                    18.30 : Tiba di Hotel, Istirahat persiapan untuk <strong>Tour Bromo</strong><br><br>
                    ...
                    20.00 : Kembali ke hotel atau ke <strong  style="font-weight: bold;">Alun alun Kota Batu untuk menimati jajanan khas Kuliner Kota Batu yaitu Ketan Legenda</strong>  <br><br>
                    ...
                    12.00 : <strong style="font-weight: bold;">Wisata Kuliner Bakso Presiden</strong> t <br>
                    ...
                    <i><strong  style="font-weight: bold;">Jadwal di atas tidaklah baku, semua tergantung dengan kondisi trafic dan jadwal kedatangan / kepulangan<br>
                      *Obyek Wisata di atas dapat di ubah sesuai dengan keinginan anda, hubungi customer service untuk perubahan obyek wisata pilihan anda</strong></i>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Afan\Documents\pbw\pbw-uas\jendelawisata\resources\views/pages/paket/tour-malang/3D2N/bromo-malang.blade.php ENDPATH**/ ?>