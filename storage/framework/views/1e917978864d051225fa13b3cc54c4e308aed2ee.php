      ...
      <div class="col-lg-4">
        ...
        <div class="card-profile pt-5">
          <a class="katalog" href="../../halaman/Tour2D1N/TourKawahijen&Baluran.html">
            <img src="../../frontend/images/katalog/detail2.jpg" width="280" height="280" alt="">
          </a>
        </div>
      </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Afan\Documents\pbw\pbw-uas\jendelawisata\resources\views/pages/paket/tour-malang/3D2N/ijen-baluran.blade.php ENDPATH**/ ?>