    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-4 ml-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a href="<?php echo e(route('bookings.create')); ?>" class="dropdown-item">Booking</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
...
<?php /**PATH C:\Users\Afan\Documents\pbw\last uas'\pbw\resources\views/includes/navbar.blade.php ENDPATH**/ ?>