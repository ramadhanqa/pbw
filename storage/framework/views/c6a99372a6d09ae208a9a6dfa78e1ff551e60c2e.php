...
Trip Kawah Ijen | Paket Tour Wisata Malang Bromo Murah Terbaik
          ...
          <div class="profile-text-main pl-lg-2">
            ...
            <nav>
              <div class="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                <a class="nav-item nav-link" id="nav-jadwalperjalanan-tab" data-toggle="tab" href="#jadwalperjalanan" role="tab" aria-controls="jadwalperjalanan" aria-selected="false">Itenary</a>
            ...
            <div class="tab-content" id="nav-tabContent">
              <div class="tab-pane fade show active" id="nav-detailtrip" role="tabpanel" aria-labelledby="nav-detailtrip-tab"><br>
               ...
               <strong> Meeting Point </strong> <span style="font-weight: lighter;">: Kota Malang & Surabaya *khusus penjemputan Surabaya dikenakan biaya tambahan  </span>
               <br><br>
               <p style="font-weight: lighter;">
                 <strong style="font-weight: bold;">Destinasi Wisata</strong>
                    - Rest Area Paltuding <br>
                    - Blue Fire Kawah Ijen <br>
                    - Sunrise Kawah Ijen <br>
                    - Panorama gunung Ijen
               </p>
              </div>
              <div class="tab-pane fade" id="nav-hargatour" role="tabpanel" aria-labelledby="nav-hargatour-tab"><br>
               <p style="font-weight: lighter;">
                6 orang : 390.000,- /orang<br>
                5 orang : 450.000,- / orang<br>
                4 orang : 550.000,- / orang<br>
                3 orang : 695.000,- / orang<br>
                2 orang : 980.000,- / orang<br><br>
                <p style="font-style: italic;"> *jumlah perserta diatas 6 orang silakan menghubungi CS kami</p>
              ...
              <div class="tab-pane fade" id="nav-fasilitas" role="tabpanel" aria-labelledby="nav-fasilitas-tab"><br>
                <p style="font-weight: lighter;">
                  ...
                  √ Transport Selama Perjalanan (1 - 4 Orang dengan Avanza dan 5 - 6 dengan Inova) <br>
                  √ Driver Us Guide <br>
                  √ Tiket entrance kawasan Kawah Ijen <br>
                  √ <strong style="font-weight: bold;"> Makan Prasmanan setelah dari Kawah Ijen (Rest Area Paltuding) </strong> <br>
                  √ Snack, Air Mineral & Masker <br>
                  √ BBM, Tol & Parkir <br>
                  √ <strong style="font-weight: bold;">Lokal Guide Ijen </strong><br>
                  √ <strong style="font-weight: bold;">Asuransi Perjalanan Wisata </strong> <br> <br>

                  <Strong>Price Exclude : </Strong> <br>
                  √ Makan di luar jadwal<br>
                  √ Logistik Selama Treking<br>
                  √ Coffee Morning<br>
                  √ Dokumentasi
                </p>
              </div>
              <div class="tab-pane fade" id="jadwalperjalanan" role="tabpanel" aria-labelledby="jadwalperjalanan"><br>
                <p style="font-weight: lighter;">
                  <strong style="font-weight: bold;">Itinerary</strong><br>
                  16.00 : Penjemputan peserta di meeting point yang ditentukan <br>
                  16.30 : start perjalanan menuju Kawah Ijen <br>
                  19.00 : Makan malam di Restoran Lokal (biaya sendiri) <br>
                  20.00 : Start kembali perjalanan menuju Ijen & Istirahat <br>
                  01.00 : Tiba di Rest Area Paltuding (Bertemu dengan Lokal Guide Kami) <br>
                  ...
                  07.30 : Makan Pagi di Rest Area Paltuding (include paket kami) dan bersih diri <br>
                  08.30 : Perjalanan kembali ke Meeting point <br>
                  16.00 : diperkirakan tiba di meeting point dan trip selesai <br> <br>
                <p style="font-style: italic;">*jadwal diatas tidak baku, jadwal sewaktu-waktu bisa berubah sesuai kodisi di lapangan tanpa mengganggu agenda secara keseluruhan</p>

                </p>
              </div>
              <div class="tab-pane fade" id="termcond" role="tabpanel" aria-labelledby="termcond"><br>
                <p style="font-weight: lighter;">
                  - Tanda jadi trip peserta diwajibkan melakukan transfer <strong>Down Payment</strong>  minimal sebesar <strong style="font-weight: bold;"> 50% </strong> dari total keseluruhan dan sisa pembayaran dilakukan saat penjemputan peserta Tour Bromo Sunrise <br>
                  ...
                  - <strong style="font-weight: bold;">Anak usia 2 th</strong>  keatas kami kenakan biaya penuh <br>
...
<?php echo $__env->make('layouts.detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Afan\Documents\pbw\pbw-uas\jendelawisata\resources\views/pages/paket/tour-malang/1D/kawah-ijen.blade.php ENDPATH**/ ?>