        ...
        <div class="col-xl-4 col-md-6 mb-4">
            ...
            <div class="card-body">
                ...
                <div class="col mr-2">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($packet); ?></div>
                </div>
                <div class="col-auto">
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            ...
            <div class="card-body">
                ...
                <div class="col mr-2">
                    ...
                    <div class="row no-gutters align-items-center">
                    <div class="col-auto">
                        <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo e($testimonial); ?></div>
                    </div>
                    </div>
                </div>
                <div class="col-auto">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Afan\Documents\pbw\last uas'\pbw\resources\views/pages/admin/dashboard.blade.php ENDPATH**/ ?>