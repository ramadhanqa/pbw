...
Bromo & Ijen | Paket Tour Wisata Malang Bromo Murah Terbaik
      ...
      <div class="col-lg-8 pl-lg-5">
        <div class="card card-profile-main">
          ...
          <div class="profile-text-main pl-lg-2">
            <p class="font-weight-bold" style="font-size: 18px;">Paket Tour Bromo & Madakaripura</p>
            ...
            <div class="tab-content" id="nav-tabContent">
              <div class="tab-pane fade show active" id="nav-detailtrip" role="tabpanel" aria-labelledby="nav-detailtrip-tab"><br>
               ...
               <strong> Meeting Point </strong>  <span style="font-weight: lighter;">: Kota Malang, Batu & Surabaya</span> <i style="font-weight: lighter;">*khusus penjemputan Surabaya dikenakan biaya tambahan</i>
               <br><br>
               <p style="font-weight: lighter;">
                 <strong style="font-weight: bold;">Destinasi Wisata</strong><br>
                - Air Terjun Madakaripura <br>
                - Spot Sunrise Bromo (Penanjakan 1/Bukit Kingkong/Bukit Cinta) <br>
                - Kawah Bromo <br>
                - Pura Luhur Poten <br>
                - Pasir Berbisik <br>
              ...
              <div class="tab-pane fade" id="nav-hargatour" role="tabpanel" aria-labelledby="nav-hargatour-tab"><br><br>
                ...
                <p style="font-weight: lighter;"><strong style="font-weight: bold;">Pilihan Hotel *3</strong> :Lava View Lodge, Bromo Permai Hotel, Cemarah Indah Hotel, Istana Petani & SM Hotel Bromo <br>
                <strong style="font-weight: bold;">Pilihan Hotel *4</strong> :Bromo Terrace Hotel, Jiwa Jawa Resort & Bromo Cottage <br><br>
                <strong style="font-style: italic; font-weight: bold;">
                *harga tidak berlaku di Periode High Season yaitu Libur Idul Fitri, Kemerdekaan RI, Natal dan Tahun Baru <br>
                *untuk peserta diatas 6 orang, silahkan hubungi kami
                </strong>
              </div>
              <div class="tab-pane fade" id="nav-fasilitas" role="tabpanel" aria-labelledby="nav-fasilitas-tab"><br>
                <p style="font-weight: lighter;">
                  ...
                  √ Transport Selama Perjalanan (<strong style="font-weight: bold;"> Innova untu 1-5 Orang</strong> ) <br>
                  √ <strong style="font-weight: bold;">Jeep 4x4 selama di Bromo</strong>  <br>
                  √ Driver Jeep as Guide <br>
                  √ Tiket entrance kawasan Wisata <br>
                  √ Akomodasi 1 Malam (pilihan Hotel di menu Price Trip) <br>
                  √ Makan Pagi <br>
              ...
              <div class="tab-pane fade" id="jadwalperjalanan" role="tabpanel" aria-labelledby="jadwalperjalanan"><br>
                <p style="font-weight: lighter;">
                  ...
                  09.00 : Penjemputan peserta di Meeting Point yang telah ditentukan <br>
                  11.00 : Tiba di Air Terjun Madakaripura (explorasi air terjun) <br>
                  13.30 : Cek out dari air Terjun Madakaripura menuju Hotel <br>
                  13.00 : Tiba di Hotel, cek in dan free program di Sekitaran Homestay / Hotel dengan view bromo <br>
                  16.30 : enjoy sunset di plataran Hotel <br>
                  18.00 : Makan malam di sekitar hotel (biaya pribadi) <br>
                  ...
                  10.00 : Kembali ke Homestay/Hotel <br>
                  11.00 : Makan dan bersih diri <br>
                  11.45 : Cek Out dan kembali ke Malang / Surabaya <br>
                  15.30 : Tiba di Meeting point yang disepakati <br> <br>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Afan\Documents\pbw\pbw-uas\jendelawisata\resources\views/pages/paket/tour-malang/2D1N/bromo-inap.blade.php ENDPATH**/ ?>